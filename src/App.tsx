...
export default function App() {
  ...
  {dialog && <Dialog title={dialog === 'help' ? 'Ready, set, discover' : dialog === 'stats' ? 'Your personal best' : dialog === 'share' ? 'Take it to the group chat' : 'About Hurdle'} onClose={() => setDialog(null)}>
